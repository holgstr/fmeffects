...
The `fme` package computes, aggregates and visualizes forward marginal effects (FMEs) for any supervised machine learning model. Read [here][4] how they are computed, or the [research paper][1] for a more in-depth understanding. There are three main functions: 
...
[4]: https://holgstr.github.io/fme/articles/fme_theory.html
