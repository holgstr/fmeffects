...
A value of 0.5 indicates that a linear effect can describe some but not all of the change of the prediction function along the bivariate feature step. This means we should be weary of interpreting the FME as a linear effect.
